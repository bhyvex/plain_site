...
module PlainSite::Data
    ...
    class PostList
        ...
        # posts - The Post[]|String[] of posts or posts file path(abs or relative to site.posts_path) array
        # site - The Site
        ...
        # The old page's date is,the smaller page's num is.
        # Options:
        ...
        def paginate(opts={})
            ...
            pages= pages.zip(nos_list,display_nums,slugs).map do |a|
                posts,nos,display_num,slug=a
                PostListPage.new(
                    nos: nos, slug: slug, display_num: display_num,
        ...
        def +(other)
            raise TypeError,"Except #{PostList}" unless PostList===other
