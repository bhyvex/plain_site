...
Post file content must start with [YAML-Front format header](http://jekyllrb.com/docs/frontmatter/),and at least contains a `title` property.
...
File `_src/routes.rb` can be used to custom url pattern and all what you want.
